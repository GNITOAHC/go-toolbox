...
// load loads the environment variables from the given file path
...
// parse parses the line and returns the key and value
...
// Load loads the environment variables from the given paths
